...
goog.exportSymbol('proto.introspection.Runtime.EventProperty', null, global)
goog.exportSymbol(
  'proto.introspection.Runtime.EventProperty.PropertyType',
  null,
  global
)
goog.exportSymbol('proto.introspection.Runtime.EventType', null, global)
 ...
 * @constructor
 */
proto.introspection.Runtime.EventType = function(opt_data) {
  jspb.Message.initialize(
    this,
    opt_data,
    0,
    -1,
    proto.introspection.Runtime.EventType.repeatedFields_,
    null
  )
}
goog.inherits(proto.introspection.Runtime.EventType, jspb.Message)
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.introspection.Runtime.EventType.displayName =
    'proto.introspection.Runtime.EventType'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.introspection.Runtime.EventProperty = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null)
}
goog.inherits(proto.introspection.Runtime.EventProperty, jspb.Message)
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.introspection.Runtime.EventProperty.displayName =
    'proto.introspection.Runtime.EventProperty'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
    ...
    var f,
      obj = {
        ...
        eventTypesList: jspb.Message.toObjectList(
          ...
          proto.introspection.Runtime.EventType.toObject,
          includeInstance
        ),
      }
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 6:
        ...
        break
      case 7:
        var value = new proto.introspection.Runtime.EventType()
        reader.readMessage(
          value,
          proto.introspection.Runtime.EventType.deserializeBinaryFromReader
        )
...
proto.introspection.Runtime.serializeBinaryToWriter = function(
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      7,
      f,
      proto.introspection.Runtime.EventType.serializeBinaryToWriter
    )
  }
}
 ...
 * @const
 */
proto.introspection.Runtime.EventType.repeatedFields_ = [2]
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.introspection.Runtime.EventType.prototype.toObject = function(
    opt_includeInstance
  ) {
    return proto.introspection.Runtime.EventType.toObject(
      opt_includeInstance,
      this
    )
  }
   ...
   *     the JSPB instance for transitional soy proto support:
   *     http://goto/soy-param-migration
   * @param {!proto.introspection.Runtime.EventType} msg The msg instance to transform.
   * @return {!Object}
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.introspection.Runtime.EventType.toObject = function(
    includeInstance,
    msg
  ) {
    var f,
      obj = {
        ...
        propertiesList: jspb.Message.toObjectList(
          ...
          proto.introspection.Runtime.EventProperty.toObject,
          includeInstance
        ),
      }
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.introspection.Runtime.EventType}
 */
proto.introspection.Runtime.EventType.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes)
  var msg = new proto.introspection.Runtime.EventType()
  return proto.introspection.Runtime.EventType.deserializeBinaryFromReader(
    msg,
    reader
  )
}
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.introspection.Runtime.EventType} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.introspection.Runtime.EventType}
 */
proto.introspection.Runtime.EventType.deserializeBinaryFromReader = function(
  msg,
  reader
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        break
      case 2:
        var value = new proto.introspection.Runtime.EventProperty()
        reader.readMessage(
          value,
          proto.introspection.Runtime.EventProperty.deserializeBinaryFromReader
        )
 ...
 * @return {!Uint8Array}
 */
proto.introspection.Runtime.EventType.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter()
  proto.introspection.Runtime.EventType.serializeBinaryToWriter(this, writer)
  return writer.getResultBuffer()
}
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.introspection.Runtime.EventType} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.introspection.Runtime.EventType.serializeBinaryToWriter = function(
  message,
  writer
) {
  var f = undefined
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.introspection.Runtime.EventProperty.serializeBinaryToWriter
    )
  }
}
 ...
 * @return {string}
 */
proto.introspection.Runtime.EventType.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ''))
}

/** @param {string} value */
proto.introspection.Runtime.EventType.prototype.setName = function(value) {
  jspb.Message.setProto3StringField(this, 1, value)
}

/**
 * repeated EventProperty properties = 2;
 * @return {!Array<!proto.introspection.Runtime.EventProperty>}
 */
proto.introspection.Runtime.EventType.prototype.getPropertiesList = function() {
  return /** @type{!Array<!proto.introspection.Runtime.EventProperty>} */ (jspb.Message.getRepeatedWrapperField(
    this,
    proto.introspection.Runtime.EventProperty,
    2
  ))
...
/** @param {!Array<!proto.introspection.Runtime.EventProperty>} value */
proto.introspection.Runtime.EventType.prototype.setPropertiesList = function(
  value
) {
...
/**
 * @param {!proto.introspection.Runtime.EventProperty=} opt_value
 * @param {number=} opt_index
 * @return {!proto.introspection.Runtime.EventProperty}
 */
proto.introspection.Runtime.EventType.prototype.addProperties = function(
  opt_value,
  opt_index
) {
 ...
 */
proto.introspection.Runtime.EventType.prototype.clearPropertiesList = function() {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.introspection.Runtime.EventProperty.prototype.toObject = function(
    opt_includeInstance
  ) {
    return proto.introspection.Runtime.EventProperty.toObject(
      opt_includeInstance,
      this
    )
  }
   ...
   *     the JSPB instance for transitional soy proto support:
   *     http://goto/soy-param-migration
   * @param {!proto.introspection.Runtime.EventProperty} msg The msg instance to transform.
   * @return {!Object}
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.introspection.Runtime.EventProperty.toObject = function(
    includeInstance,
    msg
  ) {
    var f,
 ...
 * @return {!proto.introspection.Runtime.EventProperty}
 */
proto.introspection.Runtime.EventProperty.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes)
  var msg = new proto.introspection.Runtime.EventProperty()
  return proto.introspection.Runtime.EventProperty.deserializeBinaryFromReader(
    msg,
    reader
  )
}
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.introspection.Runtime.EventProperty} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.introspection.Runtime.EventProperty}
 */
proto.introspection.Runtime.EventProperty.deserializeBinaryFromReader = function(
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @return {!Uint8Array}
 */
proto.introspection.Runtime.EventProperty.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter()
  proto.introspection.Runtime.EventProperty.serializeBinaryToWriter(
    this,
    writer
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.introspection.Runtime.EventProperty} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.introspection.Runtime.EventProperty.serializeBinaryToWriter = function(
  message,
  writer
) {
  var f = undefined
 ...
 * @return {string}
 */
proto.introspection.Runtime.EventProperty.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ''))
}

/** @param {string} value */
proto.introspection.Runtime.EventProperty.prototype.setName = function(value) {
  jspb.Message.setProto3StringField(this, 1, value)
}

/**
 * optional PropertyType type = 2;
 * @return {!proto.introspection.Runtime.EventProperty.PropertyType}
 */
proto.introspection.Runtime.EventProperty.prototype.getType = function() {
  return /** @type {!proto.introspection.Runtime.EventProperty.PropertyType} */ (jspb.Message.getFieldWithDefault(
    this,
    2,
    0
  ))
 ...
 * @return {!Array<!proto.introspection.Runtime.EventType>}
 */
proto.introspection.Runtime.prototype.getEventTypesList = function() {
  return /** @type{!Array<!proto.introspection.Runtime.EventType>} */ (jspb.Message.getRepeatedWrapperField(
    this,
    proto.introspection.Runtime.EventType,
    7
  ))
...
/** @param {!Array<!proto.introspection.Runtime.EventType>} value */
proto.introspection.Runtime.prototype.setEventTypesList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 7, value)
}

/**
 * @param {!proto.introspection.Runtime.EventType=} opt_value
 * @param {number=} opt_index
 * @return {!proto.introspection.Runtime.EventType}
 */
 ...
 * @const
 */
proto.introspection.ProtocolDataPacket.oneofGroups_ = [[2, 3, 4]]
 ...
 * @return {?proto.introspection.Event}
 */
proto.introspection.ProtocolDataPacket.prototype.getEvent = function() {
 ...
 * @return {boolean}
 */
proto.introspection.ProtocolDataPacket.prototype.hasEvent = function() {
  return jspb.Message.getField(this, 4) != null
}
